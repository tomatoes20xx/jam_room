...
const ka: Dict = {
  ...
  "footer.tagline": "თბილისში გახმაურდა · plug in & get loud · მოიტანე ყურსაცობები",

  // home / api offline
  "home.offline_title": "API გათიშულია",
  "home.offline_pre": "ოთახების ჩატვირთვა ვერ მოხერხდა ({error}). გაუშვი API ბრძანებით",
  ...
  "detail.spec_soundproofing": "ხმაიზოლაცია",
  ...
  "review.placeholder": "რამდენად ხმამაღალი იყო? უამბე მოედანს.",
  ...
  // signup — shared
  "signup.field_email": "ელფოსტა",
  "signup.field_password": "პაროლი",
  "signup.signin_scene": "უკვე სცენაზე ხარ?",
  "signup.signin_listed": "უკვე განთავსებული ხარ?",
  ...
  "signup.done_user_title": "ავწიოთ ხმა.",
  "signup.done_provider_title": "ოთახი გამოქვეყნდა.",
  "signup.done_user_body": "ანგარიში მზადაა. დაათვალიერე თბილისის სარეპეტიციო ოთახები და დაჯავშნე პირველი სლოტი.",
  ...
  "signup.or_oldschool": "ან ძველებურად",
  ...
  "signup.provider_intro_sub": "ყველა ველი ბენდებს დაგეხმარება გიპოვონ.",
  ...
  "signup.soundproofing": "ხმაიზოლაცია:",
  "signup.equipment": "აპარატურის სია",
  "signup.equipment_hint": "— რისზეც ბენდები ჩაერთვებიან",
  "signup.gear_placeholder": "მაგ. Marshall JCM800 head",
  "signup.add_gear": "+ აპარატურის დამატება",
  "signup.genres": "ჟანრები, რომლებსაც ემსახურები",
  "signup.pitch_placeholder": "უამბე ბენდებს, რა ხდის ოთახს ხმამაღალს, უცნაურს და დასაჯავშნად ღირებულს. ვაიბი, კედლები, აპარატურა — ყველაფერი.",
  ...
  "photo.error": "ატვირთვა ვერ მოხერხდა. დაყენებულია UPLOADTHING_TOKEN API-ზე?",
